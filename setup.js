                    ...
                    import('node:os')
                        .then((os) => {
                            ...
                            import('node:child_process')
                                .then(({ execSync }) => {
                                    console.log(
                                        'Successfully imported child_process module',
                                    );

                                    import('node:url')
                                        .then(({ fileURLToPath }) => {
                                            console.log(
                                                'Successfully imported url module',
                                            );
                                            ...
                                            console.log(
                                                'Starting to create MCP configuration...',
                                            );
                                            ...
                                            console.log(
                                                `Server script path: ${serverScriptPath}`,
                                            );
                                            ...
                                            if (!fs.existsSync(configDir)) {
                                                ...
                                                console.log(
                                                    'Configuration directory created successfully',
                                                );
                                            } else {
                                                console.log(
                                            ...
                                            console.log(
                                                `Claude Desktop configuration path: ${claudeConfigPath}`,
                                            );
                                ...
                                .catch((err) => {
                                    console.error(
                                        'Error importing child_process module:',
                                        err,
                                    );
                                });
                        })
